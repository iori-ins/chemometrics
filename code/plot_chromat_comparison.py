...
weth_dict = {"01":"today", "02":"1 days", "03":"3 days", "04":"1 week", "05":"2 weeks",
...
for target_file in fig_type:
    ...
    fig.text(0.09, 0.5, 'Relative intensity', rotation='vertical', va='center', transform = fig.transFigure)
    #読みだすファイルをループする
    fig_num = 1
...
"""
Created on Wed Apr  1 09:09:01 2020
