...
ref_dir = os.path.abspath(r"C:\Users\Chem3-MT\Documents\04.プログラミング\Python\油類鑑定\AIA\similarity\CSV_file\refference")
sample_dir = os.path.abspath(r"C:\Users\Chem3-MT\Documents\04.プログラミング\Python\油類鑑定\AIA\similarity\CSV_file\sample")
...
title_g = 'pearson_sim_g_{0:%Y%m%d%H}.csv'.format(now)
title_k = 'pearson_sim_k_{0:%Y%m%d%H}.csv'.format(now)
...
#TODO:各標品との類似度の計算
        ...
        for r in range(len(ref)):
            similarity[r].append(round(tool.pearson_sim(intensity, ref[r][ion_index][1:]), 2))
...
"""
Created on Tue Apr  7 15:04:39 2020
